...
maxpeakwidth <- ceiling(maxpeakwidth)
...
if (Software  == "XCMS"){
  if (length(filename) > 1) {
  setwd(directory)
  dir.create("Universal Parameters for XCMS")
  setwd("Universal Parameters for XCMS")
  png(file="Universal Parameters for XCMS.png",width=1500, height=1300)
  par(mfrow=c(3,2))
  ...
  pdf(file = "Recommeded parameters for XCMS.pdf", height=6, width=8.5)
...
if (Software == "MSDIAL"){
  if (length(filename) > 1) {
  setwd(directory)
  dir.create("Universal Parameters for MSDIAL")
  setwd("Universal Parameters for MSDIAL")
  png(file="Universal Parameters for MSDIAL.png",width=1500, height=1300)
  par(mfrow=c(3,2))
  ...
  pdf(file = "Recommeded parameters for MSDIAL.pdf", height=6, width=8.5)
...
if (Software == "MZMINE2"){
  if (length(filename) > 1) {
  setwd(directory)
  dir.create("Universal Parameters for MZMINE2")
  setwd("Universal Parameters for MZMINE2")
  png(file="Universal Parameters for MZMINE2.png",width=1500, height=1600)
  par(mfrow=c(4,2))
  ...
  pdf(file = "Recommeded parameters for MZMINE2.pdf", height=6, width=12)
